...
def _effective_spec(config: dict[str, Any]) -> dict[str, Any]:
    ...
    mapped = {
        ...
        "bear_on": _as_float(config.get("bear_on"), strategy_config.get("bear_on", 0.3892)),
        ...
        "rebound_ret_max": _as_float(config.get("rebound_ret_max"), strategy_config.get("rebound_ret_max", 0.0364)),
        "rebound_sma_mult": _as_float(config.get("rebound_sma_mult"), strategy_config.get("rebound_sma_mult", 1.005)),
        "short_target_vol": _as_float(config.get("short_target_vol"), strategy_config.get("short_target_vol", 1.0622)),
        "short_floor_cap": _as_float(config.get("short_floor_cap"), strategy_config.get("short_floor_cap", 1.8962)),
        "max_short_weight": _as_float(config.get("max_short_weight"), strategy_config.get("max_short_weight", 1.7936)),
        ...
        "weight_scale": _as_float(config.get("weight_scale"), strategy_config.get("weight_scale", 1.3308)),
        "vol_ceiling": _as_float(config.get("vol_ceiling"), strategy_config.get("vol_ceiling", 0.3268)),
        "vol_floor_min": _as_float(config.get("vol_floor_min"), strategy_config.get("vol_floor_min", 0.20)),
        "high_vol_floor": _as_float(config.get("high_vol_floor"), strategy_config.get("high_vol_floor", 0.4086)),
        "high_vol_ceiling": _as_float(config.get("high_vol_ceiling"), strategy_config.get("high_vol_ceiling", 0.6006)),
        ...
        "long_on": _as_float(config.get("long_on"), strategy_config.get("long_on", 0.4532)),
        "long_ret_mid_min": _as_float(config.get("long_ret_mid_min"), strategy_config.get("long_ret_mid_min", -0.0072)),
        "long_sma_mult": _as_float(config.get("long_sma_mult"), strategy_config.get("long_sma_mult", 1.0)),
        "long_vol_ceiling": _as_float(config.get("long_vol_ceiling"), strategy_config.get("long_vol_ceiling", 0.5325)),
        "long_floor_cap": _as_float(config.get("long_floor_cap"), strategy_config.get("long_floor_cap", 0.4790)),
        "max_long_weight": _as_float(config.get("max_long_weight"), strategy_config.get("max_long_weight", 0.6368)),
        "dynamic_long_cap": _as_float(config.get("dynamic_long_cap"), strategy_config.get("dynamic_long_cap", 0.6266)),
        "dynamic_short_cap": _as_float(config.get("dynamic_short_cap"), strategy_config.get("dynamic_short_cap", 0.1395)),
        "range_mr_cap": _as_float(config.get("range_mr_cap"), strategy_config.get("range_mr_cap", 0.2155)),
        "range_z_entry": _as_float(config.get("range_z_entry"), strategy_config.get("range_z_entry", 0.8910)),
        "range_trend_max": _as_float(config.get("range_trend_max"), strategy_config.get("range_trend_max", 0.6447)),
        "range_bear_max": _as_float(config.get("range_bear_max"), strategy_config.get("range_bear_max", 0.5977)),
        "range_vol_ceiling": _as_float(config.get("range_vol_ceiling"), strategy_config.get("range_vol_ceiling", 0.6684)),
    }
